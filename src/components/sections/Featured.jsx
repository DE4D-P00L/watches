import { featured } from "../../data/watch.js";
import Card from "../UI/Card.jsx";

const Featured = () => {
  return (
    <section className="flex flex-col items-center gap-3 min-h-[50dvh]">
      <h2 className="uppercase text-center font-semibold text-xl py-4 border-t-4 border-[#f06d48]">
        Featured
      </h2>
      <div className="flex py-5 gap-10 flex-wrap justify-center px-3">
        {featured.map((watch, i) => (
          <Card
            key={i}
            className="min-h-[300px] group max-w-[300px] min-w-[300px]">
            <img
              src={watch.image}
              alt=""
